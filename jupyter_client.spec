...
Source0  : https://files.pythonhosted.org/packages/fa/84/440ef480bb829ac648f8e9d7f17c9e2b2470de18ccab989ffa25a64c8c9f/jupyter_client-6.1.3.tar.gz
...
%prep
%setup -q -n jupyter_client-6.1.3
cd %{_builddir}/jupyter_client-6.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587055776
...
cp %{_builddir}/jupyter_client-6.1.3/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_client/4864371bd27fe802d84990e2a5ee0d60bb29e944
