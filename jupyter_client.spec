...
Source0  : https://files.pythonhosted.org/packages/d1/fa/e5e8b9c7cd3d2338431d92762d238383be8d5a80ca7834671ccd78e42b8a/jupyter_client-7.0.5.tar.gz
...
%prep
%setup -q -n jupyter_client-7.0.5
cd %{_builddir}/jupyter_client-7.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632947646
...
cp %{_builddir}/jupyter_client-7.0.5/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_client/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
