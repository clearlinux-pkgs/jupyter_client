...
Source0  : https://files.pythonhosted.org/packages/5e/f2/29dc6ef4c734cdad56ae15dd50af00c2804ed2f1271c5b2413d0ae6ad091/jupyter_client-6.1.2.tar.gz
...
%prep
%setup -q -n jupyter_client-6.1.2
cd %{_builddir}/jupyter_client-6.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585266428
...
cp %{_builddir}/jupyter_client-6.1.2/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_client/4864371bd27fe802d84990e2a5ee0d60bb29e944
