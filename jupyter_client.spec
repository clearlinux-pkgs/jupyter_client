...
%prep
%setup -q -n jupyter_client-6.1.11
cd %{_builddir}/jupyter_client-6.1.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610207368
...
cp %{_builddir}/jupyter_client-6.1.11/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_client/4864371bd27fe802d84990e2a5ee0d60bb29e944
