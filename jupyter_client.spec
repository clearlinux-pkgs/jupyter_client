...
Source0  : https://files.pythonhosted.org/packages/c3/7a/53e652fb8cbca92ae5f325cbd8b2ba123b57fbc1cc5e8a47ad1c62d75e93/jupyter_client-6.1.7.tar.gz
...
%prep
%setup -q -n jupyter_client-6.1.7
cd %{_builddir}/jupyter_client-6.1.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598636304
...
cp %{_builddir}/jupyter_client-6.1.7/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_client/4864371bd27fe802d84990e2a5ee0d60bb29e944
