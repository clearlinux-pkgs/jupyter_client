...
Source0  : https://files.pythonhosted.org/packages/de/05/6b1809dbe46e21c4018721c14a989a150ff73b4ecf631fe6e22d02cac579/jupyter_client-6.1.12.tar.gz
...
%prep
%setup -q -n jupyter_client-6.1.12
cd %{_builddir}/jupyter_client-6.1.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615818038
...
cp %{_builddir}/jupyter_client-6.1.12/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_client/4864371bd27fe802d84990e2a5ee0d60bb29e944
