...
Version  : 6.1.5
Release  : 46
URL      : https://files.pythonhosted.org/packages/7a/b9/19caca13db50de6726f895b4fcfc9306f172d9744aaf0c185073c6f9e1f1/jupyter_client-6.1.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/7a/b9/19caca13db50de6726f895b4fcfc9306f172d9744aaf0c185073c6f9e1f1/jupyter_client-6.1.5.tar.gz
...
%prep
%setup -q -n jupyter_client-6.1.5
cd %{_builddir}/jupyter_client-6.1.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593528065
...
cp %{_builddir}/jupyter_client-6.1.5/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_client/4864371bd27fe802d84990e2a5ee0d60bb29e944
