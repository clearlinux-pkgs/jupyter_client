...
Source0  : https://files.pythonhosted.org/packages/19/aa/a4b27bb6cdfe870cf56bc5821e9fa54afd80164dc2344fd47194a987f0e9/jupyter_client-6.1.6.tar.gz
...
%prep
%setup -q -n jupyter_client-6.1.6
cd %{_builddir}/jupyter_client-6.1.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594824213
...
cp %{_builddir}/jupyter_client-6.1.6/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_client/4864371bd27fe802d84990e2a5ee0d60bb29e944
