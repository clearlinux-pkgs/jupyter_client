...
Version  : 7.0.4
Release  : 61
URL      : https://files.pythonhosted.org/packages/3a/60/93431efe42bd110e4c323c03fd1902a3d35494fecf948cb1922ea5a7401d/jupyter_client-7.0.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/3a/60/93431efe42bd110e4c323c03fd1902a3d35494fecf948cb1922ea5a7401d/jupyter_client-7.0.4.tar.gz
...
%prep
%setup -q -n jupyter_client-7.0.4
cd %{_builddir}/jupyter_client-7.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632839087
...
cp %{_builddir}/jupyter_client-7.0.4/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_client/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
