...
Source0  : https://files.pythonhosted.org/packages/0e/9e/9356c9a71ab5a5355b609b02f4ff939d20d8c8a7fb5edde26bda3207a74c/jupyter_client-7.0.1.tar.gz
...
%prep
%setup -q -n jupyter_client-7.0.1
cd %{_builddir}/jupyter_client-7.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629469983
...
cp %{_builddir}/jupyter_client-7.0.1/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_client/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
