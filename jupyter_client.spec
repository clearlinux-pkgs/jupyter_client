...
Source0  : https://files.pythonhosted.org/packages/be/4f/7d2e1764ba352cf764d5e08fa4a1576c3e11e5c233e832b7f03af2e39482/jupyter_client-7.0.6.tar.gz
...
%prep
%setup -q -n jupyter_client-7.0.6
cd %{_builddir}/jupyter_client-7.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633444689
...
cp %{_builddir}/jupyter_client-7.0.6/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_client/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
